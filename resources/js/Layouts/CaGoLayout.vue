<template> 
    <header>
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar shadow" >
            ...
            <div class="position-sticky mt-2 py-4" id="sidebarMenuLinkDiv">
                    <p class="sidebar-heading text-green align-items-left fs-8 fw-bold px-3 my-3">
                        <span>Apps and Widgets</span>
                    </p>
                    <ul class="nav flex-column">
                        <li class="nav-item ">
                            <sidebar-link :href="route('CaGo.CaGoDashboardIndex')" :active="route().current('CaGo.CaGoDashboardIndex')">
                                Dashboard 
                    ...
                    <ul class="nav flex-column mb-2">
                        <li class="nav-item">
                            ...
                            <sidebar-link :href="route('CaGo.UserAccounts')" :method="'get'" :data="{ perPage: '10', type: 'farmer' }" :active="$page.url  === '/CaGo/UserAccounts?perPage=10&type=farmer'">
                                Farmer
                                <i class="bi bi-brightness-high"></i>
                            </sidebar-link>
                        </li>
                        <li class="nav-item">
                            <sidebar-link :href="route('CaGo.UserAccounts')" :method="'get'" :data="{ perPage: '10', type: 'trader' }" :active="$page.url  === '/CaGo/UserAccounts?perPage=10&type=trader'">
                                Trader
                    ...
                    <ul class="nav flex-column mb-2">
                        <li class="nav-item">
                            ...
                            <sidebar-link :href="route('CaGo.Commitments')" :method="'get'" :data="{ perPage: '10'}" :active="$page.url  === '/CaGo/Commitments?perPage=10'">
                                Commitments
                                <i class="bi bi-brightness-high"></i>
                            </sidebar-link>
                        </li>
