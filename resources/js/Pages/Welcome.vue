<template>
  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-main-2">
    <div class="container px-4 px-lg-5">
        <a class="navbar-brand" href="#!">
          <img style="height:50px; width:100%;" src="/images/agrihublogo.png" alt="">
        </a>
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
        
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
              <li class="nav-item"><a class="nav-link color-main active" href="index.html">Home</a></li>
              <li class="nav-item"><a class="nav-link color-main" href="about.html">About</a></li>
              <li class="nav-item"><a class="nav-link color-main" href="contact.html">Contact</a></li>
              <li class="nav-item"><a class="nav-link color-main" href="faq.html">FAQ</a></li>
              
              <li v-if="$page.props.user" class="nav-item dropdown">
                  <a class="nav-link color-main dropdown-toggle" id="navbarDropdownPortfolio" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Portfolio</a>
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownPortfolio">
                      <li><a class="dropdown-item" :href="route('dashboard')" >Dashboard</a></li>
                      <li><a class="dropdown-item" href="portfolio-overview.html">My Profile</a></li>
                      <li><a class="dropdown-item" href="portfolio-item.html">Sign out</a></li>
                  </ul>
              </li>

              <template v-else>
                  <li class="nav-item"><a class="nav-link color-main" :href="route('login')">Sign in</a></li>
              </template>
          </ul>
        </div>
    </div>
  ...
  <header style="">
    <div id="carouselExampleControls" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner vh-100">
            ...
            <div class="carousel-item h-100 active" data-bs-interval="5000" id="carousel-img-1">
                <div class="carousel-caption text-start">
                    <h1 class="mb-4 display-3 fw-bolder">AgriHub</h1>
                  <p style="font-size: 16px;">Catalyzes market forces and facilitates data-based planning and decision making</p>

                    <button type="button" class="btn btn-main fw-bolder"> Get started <i class="bi bi-key" ></i> </button>
                </div>
            </div>

            <div class="carousel-item h-100" data-bs-interval="5000" id="carousel-img-2">
              <div class="carousel-caption text-end">
                <h1 class="mb-4 display-3 fw-bolder">Voice of the farmers</h1>
                <p style="font-size: 16px;">The struggles of farming is quite harsh. And we don't want to be mute about it. It is true that the higher agricultural input dangers us for more losses.</p>

                <button type="button" class="btn btn-main fw-bolder"> Sign in <i class="bi bi-box-arrow-in-right" ></i> </button>
              </div>
            </div>

            <div class="carousel-item h-100" data-bs-interval="5000" id="carousel-img-3">
              <div class="carousel-caption text-end">
                <h1 class="mb-4 display-3 fw-bolder">An industry that feeds us is worth innovating</h1>
                <p style="font-size: 16px;">The world is learning a few great things from a small city like ours. Bravo Butuan!</p>

                <button type="button" class="btn btn-main fw-bolder"> Sign in <i class="bi bi-box-arrow-in-right" ></i> </button>
              </div>
            </div>

            <div class="carousel-item h-100" data-bs-interval="5000" id="carousel-img-4">
              <div class="carousel-caption text-end">
                <figure>
                  <blockquote class="blockquote">
                    <h1 class="mb-4 display-3 fw-bolder">We created AgriBoost, We are part of the process. This is ours</h1>
                  </blockquote>
                  <figcaption class="blockquote-footer text-white">
                    Engr. Pierre Anthony D. Joven <cite title="Source Title">Source Title</cite>
                  </figcaption>
                </figure>
                <p style="font-size: 16px;">A multi-faceted community is difficult to manage since we have different interests. However, we have seen a genuine participation from different stakeholders in the community when we talk about our food production.</p>

                <button type="button" class="btn btn-main fw-bolder"> Sign in <i class="bi bi-box-arrow-in-right" ></i> </button>
              </div>
            </div>
            
            <div class="carousel-item h-100" data-bs-interval="5000" id="carousel-img-5">
              <div class="carousel-caption text-end">
                <h1 class="mb-4 display-3 fw-bolder">For sustainable, food secured and vibrant community.</h1>
                <p style="font-size: 16px;">Everything is becoming certain where agriculture is calculated and innovated. And through AgriBoost innovation with definite numbers and data, and ensured supply and plan, consumers will be protected from exploitation.</p>
