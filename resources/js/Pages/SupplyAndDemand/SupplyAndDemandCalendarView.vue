    ...
    <component :is="layout">
        <div class="container-fluid">
            ...
            <section class="row bg-white mb-2 mt-0 mx-2 rounded-8 py-4">
                <supply-and-demand-calendar :eventsData="this.DemandAndSupply" :RoutePrefix="this.RoutePrefix"></supply-and-demand-calendar>
            </section>
        </div>
...
<script>
    ...
    import SupplyAndDemandCalendar from '../../Components/Calendar.vue'
    ...
    export default {
        components: {
            ...
            TablePagination,
            Link,
            SupplyAndDemandCalendar,
        },
        mixins: [Helpers],
        props: ['DemandAndSupply', 'RoutePrefix'],
		data() {
			return {
        ...
        created: function(){
            console.log("DemandsAndSupply");
            console.log(this.DemandsAndSupply);
